...
<div class="ui container containerPrincipal segment" id="containerToInformations" style="">
    <div class="ui secondary menu">
        ...
        <div class="right menu">
            <button onclick="#" class="ui teal icon button">Atualizar Ano</button>
        </div>
    </div>
        ...
        <div class="two fields">
            ...
            <div class="field">
                <div class="two fields">
                    ...
                    <div class="field">
                        <label>&nbsp;&nbsp;Ano:</label>
                        <select name="blocos"  class="ui fluid dropdown" id="filtro_pesquisa_Ano">
                            <option value="0">Todos</option>
                            <?php
                            ?>

                            <script>
                                $('#filtro_pesquisa_Ano').dropdown();
                            </script>
